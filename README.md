...
| EP005 | [用 GLM-5.3 搭 A 股投研工作流](EP005_glm53-tradingagents-workflow/) | 给多 Agent 交易框架补四个模块,每天早上自动推手机 | 提示词 + 复现步骤 + 报告样本 · 插件另开仓库 [studio](https://github.com/frank-quant/TradingAgents-CN-studio) | 〔待补〕 |
